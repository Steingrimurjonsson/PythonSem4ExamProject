...
class TwitterSignUpBot():
    def __init__(self, username, email, password):
        ...
        #Wait 10 sec to make sure the email it at the top (TODO maybe make a filter to look for the right email and then make an interval loop that keeps checking for the right email.)
        sleep(10)
